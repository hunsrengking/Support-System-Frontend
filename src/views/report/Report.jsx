  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-green-50 text-green-600 hover:bg-green-100"
          >
      ...
      <form
        ...
        className="bg-white rounded-2xl p-5 shadow-sm  grid grid-cols-1 md:grid-cols-4 gap-4"
      >
        <div>
        ...
        <div className="flex items-end">
          <button
            type="submit"
            className="w-full bg-gray-900 text-white rounded-lg py-2 hover:bg-gray-800"
          >
